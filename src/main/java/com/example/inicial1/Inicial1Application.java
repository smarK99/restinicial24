...
public class Inicial1Application {
	...
	//Su responsabilidad principal es iniciar la aplicacion

	/*No tiene acceso directo a la inyeccion de dependencias
	* por que el contexto de spring todavia no estará inicializado
	* completamente
	 */
	...
	/*El código dentro de este bloque se ejecutará después de que
	* la aplicación Spring Boot se haya iniciado completamente.
	* Separamos responsabilidades con el metodo main y ejecutamos
	* todo esto despues
	*/
//	@Bean
//	@Transactional
